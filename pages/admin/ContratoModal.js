      ...
      <div style={{
        ...
        <div id="contrato-imprimible">
          ...
          <div style={{ fontSize: '10px', lineHeight: '1.35', textAlign: 'justify', borderBottom: '1px solid #ccc', paddingBottom: '10px', marginBottom: '15px' }}>
            ...
            <p style={{ margin: '0 0 6px' }}><strong>6. CONDICIONES ADICIONALES E IMPORTANTES:</strong> 6.1. Estado del Vehículo: El CLIENTE declara recibir el vehículo en perfectas condiciones mecánicas, estéticas y de limpieza, y se compromete a devolverlo en las mismas condiciones exactas. 6.2. Nivel de Combustible: El vehículo debe ser devuelto con la misma cantidad de combustible entregado. 6.3. Uso Permitido y Prohibiciones: El vehículo solo podrá ser conducido por el CLIENTE o conductores autorizados. Prohibido subarrendar, carreras o transportar cargas ilícitas/pesadas. 6.4. Llaves y Neumáticos: Pérdida o daño de llaves y neumáticos corren por cuenta del CLIENTE. 6.5.  Asistencia y Reporte de Siniestros: En caso de accidente, avería o robo, el CLIENTE debe notificar inmediatamente a MONACO LUXURY RENT A CAR y a las autoridades
policiales de tránsito en un plazo no mayor a 2 horas desde ocurrido el evento. 6.6. Compensación por Inmovilización y Pérdida de Uso (Loss of Use): Además de los costos de reparación material del vehículo descritos en este contrato, el CLIENTE acepta y
