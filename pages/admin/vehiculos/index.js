...
export default function GestionVehiculos() {
  ...
  if (loading) {
    return (
      <div style={{ color: '#fff', textAlign: 'center', padding: '50px', backgroundColor: '#0a0a0a', minHeight: '100vh' }}>
        Cargando flota...
      </div>
    );
  }
    ...
    <div style={{ backgroundColor: '#0a0a0a', minHeight: '100vh', color: '#fff', padding: '20px', fontFamily: 'sans-serif' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', borderBottom: '1px solid #222', paddingBottom: '15px' }}>
        ...
        <div style={{ display: 'flex', gap: '10px' }}>
          <a href="/admin/vehiculos/nuevo" style={{ padding: '8px 14px', backgroundColor: '#d4af37', color: '#000', textDecoration: 'none', borderRadius: '4px', fontSize: '12px', fontWeight: 'bold' }}>
            + Agregar Vehículo
          </a>
